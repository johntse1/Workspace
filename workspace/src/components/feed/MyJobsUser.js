      ...
      if(props.post.status == 'Complete')
        return(
          ...
          <div key={props.post._id} className='post'>
            ...
            <Link to={{pathname: '/reviewUser', state: props.post._id}}><Button text='Review' onClick={displayTitle}></Button></Link>
          </div>
          </div>)
